...
### Changed
- **Branding**: Updated from Fleek to AlternateFutures
  - Renamed asset files (fleekLogo.svg → afLogo.svg, fleekMark.svg → afMark.svg)
...
- Deployment configuration for Fleek
